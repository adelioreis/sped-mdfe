...
namespace NFePHP\MDFe\Deprecated;
...
use NFePHP\MDFe\Deprecated\Certificate\Pkcs12;
use NFePHP\MDFe\Deprecated\Soap\CurlSoap;
...
class BaseTools
{
    ...
    public function __construct($configJson = '')
    {
        ...
        if (is_file($configJson)) {
            $configJson = FilesFolders::readFile($configJson);
        }
    ...
    protected function zGravaFile(
        ...
        $pathTemp = FilesFolders::getFilePath($tpAmb, $path, $subFolder)
            . DIRECTORY_SEPARATOR.$anomes;
        if (!FilesFolders::saveFile($pathTemp, $filename, $data)) {
