...
class Make300
{
     ...
     * @param string $respSeg, responsável pelo seguro - Preencher com: 1- Emitente do MDF-e / 2 - Responsável pela contratação do serviço de transporte contratante).
     * @param string $CNPJ, Número do CNPJ do responsável pelo seguro - Obrigatório apenas se responsável pelo seguro for (2) responsável pela contratação do transporte - pessoa jurídica.
     * @param string $CPF, Número do CPF do responsável pelo seguro - Obrigatório apenas se responsável pelo seguro for (2) responsável pela contratação do transporte - pessoa física.
     */
     ...
     * @param string $xSeg, Nome da Seguradora.
     * @param string $CNPJ, Número do CNPJ da seguradora.
    ...
    public function tagInfANTT(
        ...
        //$this->dom->appChild($this->infANTT, $this->infCIOT, 'Falta tag "infANTT"');
        $this->dom->appChild($this->infANTT, $this->infContratante, 'Falta tag "infANTT"');
    }

    /**
     * Processa iformações do seguro
     */
    ...
    {
        if (!empty($this->rodo)) {
            $this->dom->appChild($this->rodo, $this->infANTT, 'Falta tag "rodo"');
